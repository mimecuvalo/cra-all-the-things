...
module.exports = function (webpackEnv, isSSR) {
  const isEnvDevelopment = webpackEnv === 'development';
  const isEnvDevelopmentOrSSR = webpackEnv === 'development' || isSSR;
  const isEnvProduction = webpackEnv === 'production';
  const isEnvProductionButNotSSR = webpackEnv === 'production' && !isSSR;
      ...
      loaders.push(
        {
          ...
          options: {
            sourceMap: isEnvProductionButNotSSR ? shouldUseSourceMap : isEnvDevelopment,
            root: paths.appSrc,
          },
        },
        {
  ...
  return {
    ...
    output: {
      // The build folder.
      path: isEnvProductionButNotSSR ? paths.appBuild : undefined,
      ...
      chunkFilename: isEnvProductionButNotSSR
        ...
        : isEnvDevelopmentOrSSR && 'static/js/[name].chunk.js',
    ...
    optimization: isSSR
      ? undefined
      : {
          minimize: isEnvProductionButNotSSR,
          minimizer: [
    ...
    resolve: {
      ...
      plugins: [
        ...
        new ModuleScopePlugin([paths.appSrc, paths.appServerSrc, paths.appSharedSrc], [
        ...
        { parser: { requireEnsure: false } },
        {
          ...
          oneOf: [
            ...
            // The preset includes JSX, Flow, TypeScript, and some ESnext features.
            {
              ...
              include: [paths.appSrc, paths.appServerSrc, paths.appSharedSrc],
              ...
              options: {
                ...
                compact: isEnvProductionButNotSSR,
              },
            },
            ...
            // Unlike the application JS, we only compile the standard ES features.
            {
              ...
              options: {
                ...
                cacheDirectory: true,
                // See #6846 for context on why cacheCompression is disabled
                cacheCompression: false, // NOTE: was isEnvProductionButNotSSR before for all-the-things
                // @remove-on-eject-begin
                cacheIdentifier: getCacheIdentifier(
                  isEnvProduction ? 'production' : isEnvDevelopment && 'development',
                  ['babel-plugin-named-asset-import', 'babel-preset-react-app', 'react-dev-utils', 'react-scripts']
            ...
            // By default we support CSS Modules with the extension .module.css
            {
              ...
              use: getStyleLoaders({
                importLoaders: 1,
                sourceMap: isEnvProductionButNotSSR
                  ? shouldUseSourceMap
                  : isEnvDevelopment,
                onlyLocals: isSSR,
              }),
    ...
    plugins: [
      ...
      // In development, it will be an empty string unless you specify "homepage"
